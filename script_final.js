...
function encode(dictionnary) {
   ...
   document.getElementById("traduction").innerText = `Here is the traduction : ${morseTrad}`;
   return morseTrad;
}
...
function decode(dictionnary) {
   ...
   document.getElementById("traduction").innerText = `Here is the traduction : ${latinTrad}`
   return latinTrad;
}